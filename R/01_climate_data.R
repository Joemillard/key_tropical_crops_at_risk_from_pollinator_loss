# originally authored by Peter Mccann
...
# Path for predicts database - to update predicts database for local project
predicts.path <-"C:/Users/joeym/Documents/PhD/Aims/Aim 2 - understand response to environmental change/Data/PREDICTS/database.rds"
...
tmp <- raster::stack(tmp.path)

# Both cru data and predicts is in WGS84
wgs84 <- raster::crs(tmp)
